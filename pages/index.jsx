...
const PROJECT_NAME = "37076290-ab5a-44a1-b88e-";
...
const IDEA_BRIEF = "Tu es un expert en création de mini-SaaS viraux, ultra rentables, optimisés pour la pub et la scalabilité.\n\nTâche:\n- À partir de la tendance suivante, conçois un mini-SaaS complet.\n\nTendance:\n\"Nom du mini-SaaS : DanceSnap\nPromesse principale : Transforme instantanément ta photo en vidéo de danse IA sur la dernière tendance TikTok, prête à être partagée.\nPain point principal : Créer facilement une vidéo dynamique et virale à partir d'une simple photo sans compétences techniques ni prise de vue compliquée.\nFonctionnalités clés :\n- Conversion photo-to-dance vidéo IA synchronisée avec une musique ";
